...
namespace TravelCompanion.Api.Data.Migrations
{
    ...
    [Migration("20260516155923_AddRecommendationRankingSignals")]
    partial class AddRecommendationRankingSignals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCompanion.Api.Models.TravelerPreference", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TravelCompanion.Api.Models.TravelerPreference", b =>
                {
                    b.HasOne("TravelCompanion.Api.Models.AppUser", "User")
                        .WithOne("TravelerPreference")
                        .HasForeignKey("TravelCompanion.Api.Models.TravelerPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
