...
public sealed class TravelChatIntentClassifierTests
{
    ...
    [InlineData("plan para desayunar", TravelChatResponseModes.FoodBreakfast)]
    [InlineData("recomendar brunch", TravelChatResponseModes.FoodBrunch)]
    [InlineData("proponeme un plan para aluerzo", TravelChatResponseModes.FoodLunch)]
    [InlineData("quiero cenar", TravelChatResponseModes.FoodDinner)]
    [InlineData("quiero un plan de templos", TravelChatResponseModes.CultureTemple)]
    [InlineData("recomendar museos", TravelChatResponseModes.CultureMuseum)]
    [InlineData("plan de arte", TravelChatResponseModes.CultureArt)]
    [InlineData("plan historico", TravelChatResponseModes.CultureHistory)]
    [InlineData("recomendar jardines", TravelChatResponseModes.NatureGarden)]
    [InlineData("quiero un onsen", TravelChatResponseModes.NatureOnsen)]
    [InlineData("compras vintage", TravelChatResponseModes.ShoppingVintage)]
    [InlineData("mercado para comprar", TravelChatResponseModes.ShoppingMarket)]
    [InlineData("mirador al atardecer", TravelChatResponseModes.ViewpointSunset)]
    [InlineData("plan para fotos", TravelChatResponseModes.ViewpointPhoto)]
    [InlineData("plan de karaoke", TravelChatResponseModes.NightlifeKaraoke)]
    [InlineData("bar de cocktails", TravelChatResponseModes.NightlifeBar)]
    [InlineData("musica en vivo", TravelChatResponseModes.NightlifeLiveMusic)]
    [InlineData("barrio local", TravelChatResponseModes.Neighborhood)]
    [InlineData("recomendar plan nocturno", TravelChatResponseModes.Nightlife)]
    [InlineData("recomendar plan para bailar", TravelChatResponseModes.Dance)]
